...
def run_module(ctx):
    ...
    import sklearn
    from sklearn import metrics, model_selection, linear_model, cluster, decomposition, preprocessing, ensemble, tree, neighbors, svm, mixture
    mymixedcasevariable = ctx.get('tensors', {}).get('mymixedcasevariable')
    ...
    print(x)
    ctx['tensors']['a_variable_with_a_long_name'] = a_variable_with_a_long_name
    ctx['tensors']['my_var_4'] = my_var_4
    ctx['tensors']['my_variable'] = my_variable
    ctx['tensors']['x'] = x
    ctx['tensors']['y'] = y
    ctx['tensors']['z'] = z
run_module(ctx)
...
def run_module(ctx):
    ...
    import sklearn
    from sklearn import metrics, model_selection, linear_model, cluster, decomposition, preprocessing, ensemble, tree, neighbors, svm, mixture
    my_variable = ctx.get('tensors', {}).get('my_variable')
...
def run_module(ctx):
    ...
    import sklearn
    from sklearn import metrics, model_selection, linear_model, cluster, decomposition, preprocessing, ensemble, tree, neighbors, svm, mixture
    my_function = ctx.get('tensors', {}).get('my_function')
...
def run_module(ctx):
    ...
    import sklearn
    from sklearn import metrics, model_selection, linear_model, cluster, decomposition, preprocessing, ensemble, tree, neighbors, svm, mixture
    my_list = ctx.get('tensors', {}).get('my_list')
